  ...
  return (
    <div className="App p-4">
      ...
      <div className="mb-4">
        ...
        <textarea className="input-modern" rows={6} value={grammarText} onChange={e => setGrammarText(e.target.value)} />
      </div>
      <div className="mb-4">
        <label className="block font-semibold">Input String:</label>
        <input type="text" className="input-modern" value={inputString} onChange={e => setInputString(e.target.value)} />
      </div>
      <button className="p-2" onClick={handleParse}>Parse</button>
          ...
          <div className="table-wrapper">
            ...
            <table className="w-full table-auto border-collapse border">
              ...
              <tbody>
                ...
                <div className={`mt-4 p-4 rounded ${result === 'Diterima' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
